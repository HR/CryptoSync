...
describe("CryptoSync Render Modules's tests", function () {
  this.timeout(10000)
  ...
  beforeEach(function () {
    this.app = new Application({
      // path: '../dest/CryptoSync-darwin-x64/CryptoSync.app/Contents/MacOS/Electron',
      path: path.join(__dirname, '../../dest/CryptoSyncTest-darwin-x64/CryptoSyncTest.app/Contents/MacOS/CryptoSyncTest')
    })
